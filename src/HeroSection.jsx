...
export default function HeroSection() {
  return (
    ...
    <div id='home' className='bg-black bg-opacity-[0.7] pt-10 hero pb-10'>
        <Header/>
        <Container className="text-white text-center mt-32">
          <div>
              <h1 className='text-[48px] xl:text-[60px] xl:w-[70%] font-bold leading-[56.8px] leading-[64px] w-[95%] mx-auto mt-10'>
                Making property selling and renting easier in Lagos
              </h1>
              <p className=' opacity-[0.8] xl:w-[70%] xl:mx-auto text-lg xl:mt-5'>With our all-in-one platform, easily list, market and manage your Lagos properties while we connect you with quality tenants and buyers.</p>
